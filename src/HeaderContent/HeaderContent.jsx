      ...
      <div className={styles.headerPhoto}>
        ...
        <div className={styles.fullTextIntro}>
          ...
          <p className={styles.introSecond}>
            ATpartners est une entreprise professionnelle qui regroupe plusieurs
            filiales: <br /> ATservices, ATimmobilier ainsi que ATpromotion.{" "}
            <br /> Nous vous aidons a réaliser vos projets.
          </p>
        </div>
        ...
        <button className={styles.discoverButton} onClick={scroll}>
